Scheme
{
   BaseSettings
   {
      ...
      Econ.Button.ArmedFgColor                     "base1"
      Econ.Button.DepressedBgColor                 "base2"
      Econ.Button.DepressedFgColor                 "base1"
      ...
      Econ.Button.PresetDefaultColorBg                "blue"
      Econ.Button.PresetArmedColorBg                  "blue"
      Econ.Button.PresetDepressedColorBg              "blue"
      ...
      Button.ArmedBgColor           "blue"  // mouseover color
      ...
      SectionedListPanel.OutOfFocusSelectedBgColor "base1"  //scoreboard, your highlight color
